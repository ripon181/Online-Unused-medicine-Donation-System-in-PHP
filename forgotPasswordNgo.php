...
if(isset($_REQUEST['pwdrst']))
{
  ...
  $check_email = mysqli_query($conn,"select email from tbl_ngo where email='$email'");
  ...
  if($res>0)
  {
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="http://localhost/online_unused_medicine_donation/passwordresetNgo.php?secret='.base64_encode($email).'">Reset Password</a></button></p>
     <br>
