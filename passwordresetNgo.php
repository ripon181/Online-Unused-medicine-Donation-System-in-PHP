...
if(isset($_REQUEST['pwdrst']))
{
  ...
  {
    $reset_pwd = mysqli_query($conn,"update tbl_ngo set password='$password' where email='$email'");
    if($reset_pwd>0)
    {
      $msg = 'Your password updated successfully <a href="ngologin.php">Click here</a> to login';
    }
    else
    {
...
if(isset($_GET['secret'])) {
    ...
    $check_details = mysqli_query($conn,"select email from tbl_ngo where email='$email'");
